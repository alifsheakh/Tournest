...
int inlock,curval,sh,pnow=-1,gg=0;
...
void result(char place[])
{
    ...
    else
    {
        ...
        {
            char des[10];
            printf("\n\n\n\t\t\t\t\t\t\t\t\t     You've Previously Booked a destination,would You like to replace it with the new one?\n\n\t\t\t\t\t\t\t\t\t\t\t\t       => YES OR NO\n\n\t\t\t\t\t\t\t\t\t\t\t\t       => ");
            scanf("%s",des);
            strlwr(des);
            if(strcmp(des,"yes")==0)
            {
...
void payment(char shh[],char save_veh[],int sh)
{
    if(pnow==1)
    {
        ...
        printf("\n\n\t\t\t\t\t\t\t\t\t\t    You Didn't Pay For Your Order,Would You Like To Pay Now? ");
        printf("\n\n\t\t\t\t\t\t\t\t\t\t\t\t\tYES or NO ");
        printf("\n\n\t\t\t\t\t\t\t\t\t\t\t\t  => ");
        scanf("%s",pnoww);
        strlwr(pnoww);
        if(strcmp(pnoww,"yes")==0)
        {
            pnow=0;
    ...
    else if(pnow==0)
    {
        ...
        printf("\n\t\t\t\t\t\t\t\t\t\t\t\t    2. Card\n");
        printf("\n\t\t\t\t\t\t\t\t\t\t\t\t    3. Bank");
        printf("\n\n\n\t\t\t\t\t\t\t\t\t\t\tWhich one Would You Like To Choose, 1 2 or 3?\n\n\t\t\t\t\t\t\t\t\t\t\t\t     => ");
    ...
    {
        printf("\n\n\n\n\t\t\t\t\t\t\t\t\t\t\t\tSorry!!! You Didn't Purchase Anything");
        paymentchoice(curval);
    }
...
void profilereg(int curval)///***********************PROFIELE*************
{
    system("cls");
    struct np *chc = root;
...
void settings(int curval)///***********************************SETTINGS************************************
{
    system("cls");
...
void editprofile(int curval)///*********************************PROFILE_EDITING
{
    system("cls");
    int x;
    struct np *a = root;
...
void introchoice(int curval,char save_hotels[],char save_veh[])
{
...
void resultchoice(char save_hotels[],char save_veh[],int curval)///**************target*******
{
